    ...
    taskList.innerHTML = tasks.map((task, index) => {
        ...
        <form data-index="${index}" class="tasks ${task.primary?"primary":""} ${task.done?"done":""}">
                <div class="main_information">
                    <input id="status${index}" data-use="done" onclick="toggleStatus(this)" class="completed_checkbox" type="checkbox" ${task.done?"checked":" "}>
                    ...
                    <input id="priority${index}" data-use="primary"  onclick="toggleStatus(this)" class="star_mark" type="checkbox" ${task.primary?"checked":" "}>
                    <label for="priority${index}" class="star_mark ${task.primary?"clicked":""}"><i class="${task.primary?"fas":"far"} fa-star"></i></label>
                    <input id="edit${index}" onclick="toggleStatus(this)" class="edit_icon" type="checkbox">
