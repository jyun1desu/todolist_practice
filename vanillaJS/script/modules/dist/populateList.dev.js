...
function populateList() {
  ...
  var sortedDonePrimary = taskHTMLlist.filter(function (el) {
    return el.includes("tasks priority status");
  }).join("");
  var sortedDoneNormal = taskHTMLlist.filter(function (el) {
    return el.includes("tasks  status");
  }).join("");
