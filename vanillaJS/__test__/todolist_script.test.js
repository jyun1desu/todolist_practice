...
describe('新增、刪除、修改', () => {
    ...
    test('刪除任務:全部1個任務，刪除1個任務', () => {
        window.localStorage = localStorage;
        localStorage.setItem('order', JSON.stringify(0))
        document.body.innerHTML = `<div class="todo_list" droppable="">
        <div id="primary_category" class="droppable_area"></div>
        <div id="normal_category" class="droppable_area">
        <form data-index="0" ondragstart="handleDragStart(event,this)" ondragend="handleDragEnd(event,this)" ondragenter="handleDragPassby(event,this)" class="tasks  " draggable="true">
        <div class="drag_icon">
        </div>
        <div class="main_information">
        <input id="status0" data-use="done" onclick="toggleStatus(this)" class="completed_checkbox" type="checkbox">
        ...
        require('../todolist_script.js');
        const container = document.body;
        const deleteButton = container.querySelector('label.delete_icon')
        ...
        const actualResult = document.body.innerHTML
